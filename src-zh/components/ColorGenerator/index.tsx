...
import {
  ...
  darkStorage,
  updateDOMColors,
} from "@site/src-zh/utils/colorUtils";
            ...
            values={{
              wcagLink: (
                <Link href="https://www.w3.org/TR/WCAG20/#visual-audio-contrast-contrast">
                  <Translate id="colorGenerator.tip.body.wcagLink.label">WCAG-AA contrast ratio</Translate>
                </Link>
              ),
            }}
          >
      ...
      <p>
        ...
        <label htmlFor="primary_color">
          <strong className="margin-right--sm">
            <Translate id="colorGenerator.inputs.primary.label">Primary Color:</Translate>
          </strong>
        </label>{" "}
        <input
          id="primary_color"
          ...
          <Translate
            ...
            values={{
              colorMode: isDarkTheme ? (
                <Translate id="colorGenerator.inputs.modeToggle.label.colorMode.light">light</Translate>
              ) : (
                <Translate id="colorGenerator.inputs.modeToggle.label.colorMode.dark">dark</Translate>
              ),
            }}
          >
            {"Edit {colorMode} mode"}
        ...
        >
          <Translate id="colorGenerator.inputs.resetButton.label">Reset</Translate>
        </button>
      </p>
      <p>
        {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
        <label htmlFor="background_color">
          <strong className="margin-right--sm">
            <Translate id="colorGenerator.inputs.background.label">Background:</Translate>
          </strong>
        </label>
        <input
          id="background_color"
      ...
      <div>
        <table className={styles.colorTable}>
          <thead>
            <tr>
              <th>
                <Translate id="colorGenerator.table.heading1">CSS Variable Name</Translate>
              </th>
              <th>
                <Translate
                          ...
                          onChange={(event) => {
                            ...
                            setShades({
                              ...
                              [variableName]: {
                                ...
                                adjustment: Number.isNaN(newValue) ? adjustment : newValue / 100.0,
                              },
                            });
                          }}
                        />
